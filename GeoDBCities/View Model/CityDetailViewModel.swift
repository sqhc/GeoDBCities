...
class CityDetailViewModel: ObservableObject{
    ...
    var searchCityDetailString = "https://wft-geo-db.p.rapidapi.com/v1/geo/cities/"
    let headers = [
        "X-RapidAPI-Key": "54217155a0mshc59ae06a0968327p12a4c1jsn682bd9007ac0",
        "X-RapidAPI-Host": "wft-geo-db.p.rapidapi.com"
    ]
    
    @Published var cityDetail: CityDetailContainer?
    ...
    func fetchCityDetail(){
        searchCityDetailString += cityId
        
        guard let url = URL(string: searchCityDetailString) else{
            hasError = true
